...
本文档基于 dashboard 1.6.3版本，目前 dashboard 已出 1.8.x版本，在安全控制方面已有很大改进，升级dashboard 1.8.2请看[这里](dashboard-1.8.2.md)。

### 部署

配置文件参考 `https://github.com/kubernetes/kubernetes` 项目目录 `kubernetes/cluster/addons/dashboard`

安装很简单 `kubectl create -f manifests/dashboard/`，主要讲解一些注意事项

请在另外窗口打开 [kubernetes-dashboard.yaml](../../manifests/dashboard/kubernetes-dashboard.yaml)
